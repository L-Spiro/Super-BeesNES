...
#ifndef SBN_PI
#define SBN_PI												3.1415926535897932384626433832795
#endif	// #ifndef SBN_PI
...
namespace sbn {
	...
	public :
		 ...
		 */
		static SBN_FORCEINLINE uint32_t						BiLinearSample_Int( uint32_t _ui32A, uint32_t _ui32B, uint32_t _ui32C, uint32_t _ui32D, uint32_t _ui32FactorX, uint32_t _ui32FactorY ) {
		 ...
		 */
		static SBN_FORCEINLINE uint32_t						LinearSample_Int( uint32_t _ui32A, uint32_t _ui32B, uint32_t _ui32FactorX ) {
			constexpr uint32_t ui32MaskRb = 0x00FF00FF;
			constexpr uint32_t ui32MaskAg = 0xFF00FF00;
		 ...
		 */
		static SBN_FORCEINLINE uint64_t						LinearSample_Int64( uint64_t _ui64A, uint64_t _ui64B, uint64_t _ui64FactorX ) {
		 ...
		 * \param _ui32FactorX The interpolation factor (A -> B).  0-256, such that 0 = _ui32A and 256 = _ui32B.
		 **/
		static SBN_FORCEINLINE void							LinearSample_SSE4( const uint32_t * _pui32A, const uint32_t * _pui32B, uint32_t * _pui32Result,  uint32_t _ui32FactorX ) {
#ifdef __SSE4_1__
		 ...
		 * \param _ui32FactorX The interpolation factor (A -> B).  0-256, such that 0 = _ui32A and 256 = _ui32B.
		 **/
		static SBN_FORCEINLINE void							LinearSample_AVX2( const uint32_t * _pui32A, const uint32_t * _pui32B, uint32_t * _pui32Result,  uint32_t _ui32FactorX ) {
#ifdef __AVX2__
		 ...
		 * \param _ui32FactorX The interpolation factor (A -> B).  0-256, such that 0 = _ui32A and 256 = _ui32B.
		 **/
		static SBN_FORCEINLINE void							LinearSample_AVX512( const uint32_t * _pui32A, const uint32_t * _pui32B, uint32_t * _pui32Result, uint32_t _ui32FactorX ) {
#ifdef __AVX512F__
			constexpr uint32_t mMaskRb	= 0x00FF00FF;
			constexpr uint32_t mMaskAg	= 0xFF00FF00;
		 ...
		 */
		static SBN_FORCEINLINE void							LinearInterpolateRow_Int( const uint32_t * _pui32SrcRow, uint32_t * _pui32DstRow, const uint32_t * _pui32Factors, uint32_t _ui32SrcW, uint32_t _ui32DstW ) {
		 ...
		 */
		static SBN_FORCEINLINE void							LinearInterpCombineRows_Int( const uint32_t * _pui32SrcRow0, const uint32_t * _pui32SrcRow1, uint32_t * _pui32DstRow, uint32_t _ui32Width, uint32_t _ui32Factor ) {
			if ( _ui32Factor == 0 ) {
		 ...
		 */
		static SBN_FORCEINLINE uint32_t						AddArgb( uint32_t _ui32Color0, uint32_t _ui32Color1 ) {
		 ...
		 */
		template <size_t _stShift>
		static SBN_FORCEINLINE uint32_t						ShiftArgbRight_Int( uint32_t _ui32Val ) {
		 ...
		 */
		template <size_t _stShift>
		static SBN_FORCEINLINE uint64_t						ShiftArgbRight_Int64( uint64_t _ui64Val ) {
		...
		static SBN_FORCEINLINE uint32_t						DivArgb_Int( uint32_t _ui32Color ) {
			return 0;
		}
		 ...
		 */
		static SBN_FORCEINLINE void							DecayArgb( uint32_t * _pui32Src, uint32_t _ui32Width, uint32_t _ui32Height ) {
		 ...
		 */
		static SBN_FORCEINLINE uint32_t						SamplingFactor_BiLinear( uint32_t _ui32SrcLen, uint32_t _ui32DstLen, uint32_t _ui32Idx ) {
		 ...
		 *	are the X index of the samples between which to interpolate.
		 */
		static SBN_FORCEINLINE uint32_t						SamplingFactor_Scanline( uint32_t _ui32SrcLen, uint32_t _ui32DstLen, uint32_t _ui32Idx ) {
		 ...
		 *	are the X index of the samples between which to interpolate.
		 */
		static SBN_FORCEINLINE uint32_t						SamplingFactor_Scanline_Sharp( uint32_t _ui32SrcLen, uint32_t _ui32DstLen, uint32_t _ui32Idx ) {
			uint32_t ui32Factor = ((_ui32SrcLen * _ui32Idx) << 8) / _ui32DstLen;
			uint32_t ui32Idx = ui32Factor >> 8;
		 ...
		 **/
		static void											DeconstructFilePath( const std::u16string &_s16Path, SBN_FILE_PATHS &_fpPaths );
		 ...
		 **/
		static std::vector<SBN_FILE_PATHS>					DeconstructFilePaths( const std::vector<std::u16string> &_s16Paths );
		 ...
		 **/
		static bool											DuplicateFiles( const std::vector<CUtilities::SBN_FILE_PATHS> &_s16Paths, std::vector<size_t> &_vIndices );
