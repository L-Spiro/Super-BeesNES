...
#include "../../BeesNES/SBNBeesNes.h"
#include "../../Display/SBNDisplayHost.h"
#include "../../Input/SBNDirectInput8Controller.h"
#include "../../Input/SBNInputPoller.h"
#include "../../Options/SBNWindowOptions.h"
...
namespace sbn {
	...
	protected :
		...
		/** Images. */
		lsw::CBitmap							m_bBitmaps[SBN_I_TOTAL];
		/** Image mapping. */
		INT										m_iImageMap[SBN_I_TOTAL];
		...
		SBN_WINDOW_OPTIONS						m_woWindowOptions;
