...
#include "SBNStdControllerPage.h"
...
namespace sbn {
	...
	CWidget::LSW_HANDLED CStdControllerPage::InitDialog() {
		...
		if ( m_pioOptions ) {
			for ( size_t I = 0; I < SBN_ELEMENTS( m_ieMainButtons ); ++I ) {
				m_ieMainButtons[I] = m_pioOptions->ieButtonMap[m_stPlayerIdx][m_stConfigIdx][I];
			}
			for ( size_t I = 0; I < SBN_ELEMENTS( m_ieTurboButtons ); ++I ) {
		...
		for ( size_t I = 0; I < vMainButtons.size(); ++I ) {
			...
			if ( m_ieMainButtons[I].dtType == SBN_INPUT_EVENT::SBN_DT_KEYBOARD && m_ieMainButtons[I].u.kb.kKey.bKeyCode != 0 ) {
		...
		for ( size_t I = 0; I < vTurboButtons.size(); ++I ) {
			...
			if ( m_ieTurboButtons[I].dtType == SBN_INPUT_EVENT::SBN_DT_KEYBOARD && m_ieTurboButtons[I].u.kb.kKey.bKeyCode != 0 ) {
		...
		for ( size_t I = 0; I < vTurboCombos.size(); ++I ) {
			...
			static const CWinUtilities::SBN_COMBO_ENTRY ceEnries[] = {
				//pwcName																					lpParm
				{ L"Std: 1010101010101010101010101010101010101010101010101010101010101010",					-1,		},
			};
			CWinUtilities::FillComboBox( vTurboCombos[I], ceEnries, SBN_ELEMENTS( ceEnries ), -1 );
		}
	...
	bool CStdControllerPage::StopListening_Keyboard( CWidget * _pwControl, bool _bSuccess ) {
		...
		if ( m_stListeningIdx < 8 ) {
			m_ieMainButtons[m_stListeningIdx].dtType = SBN_INPUT_EVENT::SBN_DT_KEYBOARD;
			m_ieMainButtons[m_stListeningIdx].u.kb.kKey = m_kResult;
		}
		else {
			m_ieTurboButtons[m_stListeningIdx%8].dtType = SBN_INPUT_EVENT::SBN_DT_KEYBOARD;
	...
	CWidget::LSW_HANDLED CStdControllerPage::Command( WORD /*_wCtrlCode*/, WORD _wId, CWidget * _pwSrc ) {
		switch ( _wId ) {
			case Layout::SBN_SCPI_BUTTON_A_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_B_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_START_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_SELECT_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_UP_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_LEFT_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_RIGHT_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_DOWN_BUTTON : {
				m_stListeningIdx = _pwSrc->GetUserData() & 0xFF;
				BeginListening_Keyboard( _pwSrc );
				return LSW_H_HANDLED;
			}
			case Layout::SBN_SCPI_BUTTON_A_TURBO_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_B_TURBO_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_START_TURBO_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_SELECT_TURBO_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_UP_TURBO_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_LEFT_TURBO_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_RIGHT_TURBO_BUTTON : {}
			case Layout::SBN_SCPI_BUTTON_DOWN_TURBO_BUTTON : {
	...
	void CStdControllerPage::UpdateDialog() {
		...
		for ( size_t I = 0; I < SBN_ELEMENTS( m_ieTurboButtons ); ++I ) {
			bool bKeySet = (m_ieTurboButtons[I].dtType == SBN_INPUT_EVENT::SBN_DT_KEYBOARD && m_ieTurboButtons[I].u.kb.kKey.bKeyCode != 0);
	...
	std::vector<lsw::CButton *> CStdControllerPage::MainButtons() {
		static const WORD wButtons[] = {
			Layout::SBN_SCPI_BUTTON_UP_BUTTON,
			Layout::SBN_SCPI_BUTTON_LEFT_BUTTON,
			Layout::SBN_SCPI_BUTTON_RIGHT_BUTTON,
			Layout::SBN_SCPI_BUTTON_DOWN_BUTTON,
			Layout::SBN_SCPI_BUTTON_SELECT_BUTTON,
			Layout::SBN_SCPI_BUTTON_START_BUTTON,
			Layout::SBN_SCPI_BUTTON_B_BUTTON,
			Layout::SBN_SCPI_BUTTON_A_BUTTON,
		};
		
		try {
			std::vector<lsw::CButton *> vRet;
			for ( size_t I = 0; I < SBN_ELEMENTS( wButtons ); ++I ) {
	...
	std::vector<lsw::CButton *> CStdControllerPage::TurboButtons() {
		static const WORD wButtons[] = {
			Layout::SBN_SCPI_BUTTON_UP_TURBO_BUTTON,
			Layout::SBN_SCPI_BUTTON_LEFT_TURBO_BUTTON,
			Layout::SBN_SCPI_BUTTON_RIGHT_TURBO_BUTTON,
			Layout::SBN_SCPI_BUTTON_DOWN_TURBO_BUTTON,
			Layout::SBN_SCPI_BUTTON_SELECT_TURBO_BUTTON,
			Layout::SBN_SCPI_BUTTON_START_TURBO_BUTTON,
			Layout::SBN_SCPI_BUTTON_B_TURBO_BUTTON,
			Layout::SBN_SCPI_BUTTON_A_TURBO_BUTTON,
		};
		try {
			std::vector<lsw::CButton *> vRet;
			for ( size_t I = 0; I < SBN_ELEMENTS( wButtons ); ++I ) {
	...
	std::vector<lsw::CComboBox *> CStdControllerPage::TurboCombos() {
		static const WORD wCombos[] = {
			Layout::SBN_SCPI_BUTTON_UP_TURBO_COMBO,
			Layout::SBN_SCPI_BUTTON_LEFT_TURBO_COMBO,
			Layout::SBN_SCPI_BUTTON_RIGHT_TURBO_COMBO,
			Layout::SBN_SCPI_BUTTON_DOWN_TURBO_COMBO,
			Layout::SBN_SCPI_BUTTON_SELECT_TURBO_COMBO,
			Layout::SBN_SCPI_BUTTON_START_TURBO_COMBO,
			Layout::SBN_SCPI_BUTTON_B_TURBO_COMBO,
			Layout::SBN_SCPI_BUTTON_A_TURBO_COMBO,
		};
		try {
			std::vector<lsw::CComboBox *> vRet;
			for ( size_t I = 0; I < SBN_ELEMENTS( wCombos ); ++I ) {
	...
	std::vector<lsw::CTrackBar *> CStdControllerPage::DeadZoneTrackBars() {
		static const WORD wTrackBars[] = {
			Layout::SBN_SCPI_BUTTON_UP_DEADZONE_TRACKBAR,
			Layout::SBN_SCPI_BUTTON_LEFT_DEADZONE_TRACKBAR,
			Layout::SBN_SCPI_BUTTON_RIGHT_DEADZONE_TRACKBAR,
			Layout::SBN_SCPI_BUTTON_DOWN_DEADZONE_TRACKBAR,
			Layout::SBN_SCPI_BUTTON_SELECT_DEADZONE_TRACKBAR,
			Layout::SBN_SCPI_BUTTON_START_DEADZONE_TRACKBAR,
			Layout::SBN_SCPI_BUTTON_B_DEADZONE_TRACKBAR,
			Layout::SBN_SCPI_BUTTON_A_DEADZONE_TRACKBAR,
		};
		try {
			std::vector<lsw::CTrackBar *> vRet;
			for ( size_t I = 0; I < SBN_ELEMENTS( wTrackBars ); ++I ) {
