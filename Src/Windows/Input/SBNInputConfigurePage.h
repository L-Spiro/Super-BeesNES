...
#include "SBNInputPage.h"
#include "../../Localization/SBNLocalization.h"
#include "../WinUtilities/SBNWinUtilities.h"
...
namespace sbn {
	...
	public :
		...
		virtual std::wstring					GetName() const {
			if constexpr ( _bGlobal ) { return SBN_LSTR( SBN_INPUT_GLOBAL_SETTINGS ); }
			else { return SBN_LSTR( SBN_INPUT_PER_GAME_SETTINGS ); }
		}
		...
		virtual LSW_HANDLED						InitDialog() {
			lsw::CComboBox * pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( CONSOLE_TYPE_COMBO ) ));
			CWinUtilities::FillComboWithConsoleTypes( pcbBox, m_ioTmpOptions.ui8ConsoleType );
			pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( EXPAND_COMBO ) ));
		...
		virtual LSW_HANDLED						Command( WORD _wCtrlCode, WORD _wId, CWidget * /*_pwSrc*/ ) {
			switch ( _wId ) {
				case CInputWindowLayout::SBN_IWI_GLOBAL( CONSOLE_TYPE_COMBO ) : {
					switch ( _wCtrlCode ) {
						case CBN_SELCHANGE : {
...
#define SBN_UPDATE_COMBO( COMBO_ID, BYTE )																	\
	case CInputWindowLayout::SBN_IWI_GLOBAL( COMBO_ID ) : {													\
		switch ( _wCtrlCode ) {																				\
			case CBN_SELCHANGE : {																			\
		...
		break;																								\
				...
				SBN_UPDATE_COMBO( EXPAND_COMBO, ui8Expansion )
				SBN_UPDATE_COMBO( PLAYER_1_COMBO, ui8Player[0] )
				SBN_UPDATE_COMBO( PLAYER_2_COMBO, ui8Player[1] )
				SBN_UPDATE_COMBO( PLAYER_3_COMBO, ui8Player[2] )
				SBN_UPDATE_COMBO( PLAYER_4_COMBO, ui8Player[3] )
#undef SBN_UPDATE_COMBO
				case CInputWindowLayout::SBN_IWI_GLOBAL( USE_GLOBAL_CHECK ) : {
					switch ( _wCtrlCode ) {
						case STN_CLICKED : {
				...
				case CInputWindowLayout::SBN_IWI_GLOBAL( USE_FOUR_SCORE_CHECK ) : {
					switch ( _wCtrlCode ) {
						case STN_CLICKED : {
	...
	protected :
		 ...
		 */
		void									SelectFamicom() {
			lsw::CComboBox * pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_1_COMBO ) ));
			if ( pcbBox ) {
				CWinUtilities::FillComboWithControllerType_Famicom( pcbBox );
			}
			pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_2_COMBO ) ));
			if ( pcbBox ) {
				CWinUtilities::FillComboWithControllerType_Famicom( pcbBox );
			}
			pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_3_COMBO ) ));
			if ( pcbBox ) {
				CWinUtilities::FillComboWithControllerType_FourScore( pcbBox, m_ioTmpOptions.ui8Player[2], SBN_CT_NONE );
			}
			pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_4_COMBO ) ));
			if ( pcbBox ) {
				CWinUtilities::FillComboWithControllerType_FourScore( pcbBox, m_ioTmpOptions.ui8Player[3], SBN_CT_NONE );
			}
		...
		void									SelectNes() {
			...
			lsw::CCheckButton * pUse4Score = static_cast<lsw::CCheckButton *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( USE_FOUR_SCORE_CHECK ) ));
			if ( pUse4Score ) {
			...
			if ( bUseFourScore ) {
				pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_1_COMBO ) ));
				CWinUtilities::FillComboWithControllerType_FourScore( pcbBox, m_ioTmpOptions.ui8Player[0], SBN_CT_NONE );

				pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_2_COMBO ) ));
				CWinUtilities::FillComboWithControllerType_FourScore( pcbBox, m_ioTmpOptions.ui8Player[1], SBN_CT_NONE );
				...
				pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_1_COMBO ) ));
				CWinUtilities::FillComboWithControllerType_NES( pcbBox, m_ioTmpOptions.ui8Player[0], SBN_CT_NONE );

				pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_2_COMBO ) ));
				CWinUtilities::FillComboWithControllerType_NES( pcbBox, m_ioTmpOptions.ui8Player[1], SBN_CT_NONE );

				pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_3_COMBO ) ));
				CWinUtilities::FillComboWithControllerType_NES( pcbBox, m_ioTmpOptions.ui8Player[2], SBN_CT_NONE );

				pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_4_COMBO ) ));
				CWinUtilities::FillComboWithControllerType_NES( pcbBox, m_ioTmpOptions.ui8Player[3], SBN_CT_NONE );
			}
		...
		void									UpdateDialog() {
			...
			lsw::CCheckButton * pUseGlobal = static_cast<lsw::CCheckButton *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( USE_GLOBAL_CHECK ) ));
			if ( pUseGlobal ) {
				bEnablePanel = pUseGlobal->IsChecked() == FALSE;
			}

			LPARAM lpConsoleType = SBN_CT_FAMICOM;
			lsw::CComboBox * pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( CONSOLE_TYPE_COMBO ) ));
			if ( pcbBox ) {
				lpConsoleType = pcbBox->GetCurSelItemData();
				pcbBox->SetEnabled( bEnablePanel );
			}
			LPARAM lpExpType = SBN_CT_NONE;
			lsw::CComboBox * pcbExpBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( EXPAND_COMBO ) ));
			if ( pcbExpBox ) {
			...
			// Visibility settings.
			lsw::CWidget * pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( EXPAND_LABEL ) );
			if ( pwTmp ) {
				pwTmp->SetVisible( lpConsoleType == SBN_CT_FAMICOM );
			}
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( EXPAND_COMBO ) );
			if ( pwTmp ) {
				pwTmp->SetVisible( lpConsoleType == SBN_CT_FAMICOM );
			}
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( EXPAND_BUTTON ) );
			if ( pwTmp ) {
				pwTmp->SetVisible( lpConsoleType == SBN_CT_FAMICOM );
			}
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( USE_FOUR_SCORE_CHECK ) );
			if ( pwTmp ) {
				pwTmp->SetVisible( lpConsoleType == SBN_CT_NES );
			}

			bool bShowRest = (lpConsoleType == SBN_CT_NES && bUseFourScore) || (lpConsoleType == SBN_CT_FAMICOM && lpExpType == SBN_CT_FOUR_PLAYER_ADAPTER);
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_3_LABEL ) );
			if ( pwTmp ) {
				pwTmp->SetVisible( bShowRest );
			}
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_3_COMBO ) );
			if ( pwTmp ) {
				pwTmp->SetVisible( bShowRest );
			}
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_3_BUTTON ) );
			if ( pwTmp ) {
				pwTmp->SetVisible( bShowRest );
			}

			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_4_LABEL ) );
			if ( pwTmp ) {
				pwTmp->SetVisible( bShowRest );
			}
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_4_COMBO ) );
			if ( pwTmp ) {
				pwTmp->SetVisible( bShowRest );
			}
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_4_BUTTON ) );
			if ( pwTmp ) {
				pwTmp->SetVisible( bShowRest );
			}
			...
			pcbBox = static_cast<lsw::CComboBox *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_1_COMBO ) ));
			if ( pcbBox ) {
				bool bEnable = pcbBox->GetCurSelItemData() != SBN_CT_NONE;
				pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_1_BUTTON ) );
				if ( pwTmp ) {
			...
			if ( pcbBox ) {
				bool bEnable = pcbBox->GetCurSelItemData() != SBN_CT_NONE;
				pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_2_BUTTON ) );
				if ( pwTmp ) {
					pwTmp->SetEnabled( bEnable && bEnablePanel );
				}
				pcbBox->SetEnabled( bEnablePanel );
			...
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_1_LABEL ) );
			if ( pwTmp ) {
				pwTmp->SetEnabled( bEnablePanel );
			}
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_2_LABEL ) );
			if ( pwTmp ) {
				pwTmp->SetEnabled( bEnablePanel );
			}
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( PLAYER_3_LABEL ) );
			...
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( EXPAND_LABEL ) );
			if ( pwTmp ) {
				pwTmp->SetEnabled( bEnablePanel );
			}
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( SETTINGS_GROUP ) );
			if ( pwTmp ) {
				pwTmp->SetEnabled( bEnablePanel );
			}
			pwTmp = FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( CONSOLE_TYPE_LABEL ) );
			if ( pwTmp ) {
				pwTmp->SetEnabled( bEnablePanel );
			}
		}
		...
		void									ApplyOptionsToDialog() {
			...
			pUseGlobal = static_cast<lsw::CCheckButton *>(FindChild( CInputWindowLayout::SBN_IWI_GLOBAL( USE_FOUR_SCORE_CHECK ) ));
			if ( pUseGlobal ) {
