...
namespace sbn {
	...
	public :
		 ...
		 */
		static bool												FillComboBox( CWidget * _pwComboBox, const SBN_COMBO_ENTRY * _pceEntries, size_t _stTotal, LPARAM _lpDefaultSelect, LPARAM _lpSelectBackup = 0 );
